...
keywords = ["Critical Nodes", "Key Nodes", "Influence Maximization", "Important Nodes", "Vital Nodes", "Influential Nodes", "Crucial Nodes", "Node Centrality"] # TODO add more keywords

max_result = 10000 # maximum query results from arXiv API for each keyword
issues_result = 200 # maximum papers to be included in the issue
...
f_is.write("---\n")
f_is.write("**Please check the [Github](https://github.com/SEU-WENJIA/Awesome-Critical-Nodes) page for a better reading experience and more papers.**\n\n")
